...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/icLogo.png
  AssetGenImage get icLogo => const AssetGenImage('assets/icons/icLogo.png');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/imgBackground.jpg
  AssetGenImage get imgBackground =>
      const AssetGenImage('assets/images/imgBackground.jpg');

  /// File path: assets/images/splash.jpg
  AssetGenImage get splash => const AssetGenImage('assets/images/splash.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [imgBackground, splash];
}
